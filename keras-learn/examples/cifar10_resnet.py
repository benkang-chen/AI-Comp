...
def resnet_layer(inputs,
    ...
    if conv_first:
        ...
        if batch_normalization:
            ...
            axis: 整数，需要标准化的轴 （通常是特征轴）。 例如，
                  在 data_format="channels_first" 的 Conv2D 层之后， 
            ...
            scale: 如果为 True，乘以 gamma。 如果为 False，gamma 不使用。 
            ...
            可以是任意的。如果将这一层作为模型的第一层， 则需要指定 input_shape 参数 
           （整数元组，不包含样本数量的维度）。
